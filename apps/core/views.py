...
from apps.listings.models import Listing, PublicInquiry, Favorite
...
def analytics_dashboard(request):
    ...
    total_draft     = Listing.objects.filter(status=Listing.Status.DRAFT).count()
    ...
    # Construire les 6 derniers mois avec valeurs par défaut à 0
    months = []
